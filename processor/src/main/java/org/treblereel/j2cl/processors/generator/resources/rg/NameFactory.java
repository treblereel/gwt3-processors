...
/**
 * Generates unqiue identifiers. Use this class to avoid generating conflicting names with user
 * code. This class isn't smart enough to know about scopes (which isn't generally a problem for
