 ...
 * the License.
 */
package org.treblereel.j2cl.processors.generator.resources.rg.util.tools;
...
public abstract class ArgHandler {
   ...
   * @param tagIndex an index into args indicating the first argument to use. If this is a handler
   *     for a flag argument. Otherwise it's the index of the "extra" argument.
   * @return the number of additional arguments consumed, not including the flag or extra argument.
   *     Alternately, returns -1 if the argument cannot be used. This will causes the program to
   *     abort and usage to be displayed.
   */
