...
/**
 * This is an extension of ClientBundle that allows for name-based lookup of resources. Note that
 * the use of the methods defined within this interface will prevent the compiler from pruning any
 * of the resources declared in the ClientBundle.
 */
