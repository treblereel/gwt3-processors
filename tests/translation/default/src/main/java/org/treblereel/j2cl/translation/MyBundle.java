...
public interface MyBundle {
  ...
  @TranslationKey(
      defaultValue = "<br/>{$var_1}<div id=\"this\">inner text {$var_2}</div>",
  ...
  @TranslationKey(
      defaultValue = "<div id=\"WOW\">3{$arg}-!!!!!!!!!!!!!!!!!</div>",
      unescapeHtmlEntities = true)
  String test11(String arg);

  @TranslationKey(
      defaultValue = "<br/>{$arg}<div id=\"this\">TranslationKey{$arg_1}</div>",
      unescapeHtmlEntities = true)
  String test6(String arg, String arg_1);

  @TranslationKey(
      defaultValue =
          "<div id=\"this\">!@#$%^*(((</div>{$arg}&amp;{$arg_1}@#$%^&amp;*(<div>{$arg_2}</div>",
      unescapeHtmlEntities = true)
  ...
  @TranslationKey(
      defaultValue = "<div id=\"this\">!@#$%^*(((</div>{$arg}&amp;{$arg_1}",
      unescapeHtmlEntities = true)
  String test8(String arg, String arg_1);

  @TranslationKey(
      defaultValue = "&amp;&lt;div id=\"{$arg}\"&gt;@TranslationKey&lt;/div&gt;",
      unescapeHtmlEntities = true)
  ...
  @TranslationKey(
      defaultValue =
          "Tests run: {$arg}, Failures: {$arg_1}, Errors: {$arg_2}, Skipped: {$arg_3}, Time elapsed: {$arg_4} sec")
  String test4(String arg, String arg_1, String arg_2, String arg_3, String arg_4);

  @TranslationKey(
      defaultValue = "<div id=\"someId\">some content<br /><a href=\"#someRef\">{$arg}</a>,</div>",
      unescapeHtmlEntities = true)
  String test10(String arg);

  @TranslationKey(
      defaultValue =
          "<div id=\"div1\"><div id=\"div2\"><div id=\"div3\">RRRRRRR{$arg}></div><div id=\"div4\"></div></div></div>",
      unescapeHtmlEntities = true)
  ...
  @TranslationKey(
      defaultValue =
          "<div id=\"_this\">!@#$%^*(((</div>{$arg}&amp;{$arg_1}@#$%^&amp;*(<div>{$arg_2}</div>")
  String test19(String arg, String arg_1, String arg_2);

  @TranslationKey(
      defaultValue = "<div id=\"_someId\">some content<br /><a href=\"#someRef\">{$arg}</a>,</div>")
  ...
  @TranslationKey(
      defaultValue =
          "<div id=\"div21\"><div id=\"div22\"><div id=\"div23\">RRRRRRR{$arg}></div><div id=\"div4\"></div></div></div>")
