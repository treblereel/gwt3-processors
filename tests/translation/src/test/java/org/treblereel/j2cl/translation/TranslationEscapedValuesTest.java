...
public class TranslationEscapedValuesTest {
    ...
    @Test
    public void test() {
        assertEquals("@TranslationKey org.treblereel.j2cl.translation.TranslationEscapedValuesTest !", impl.test(getClass().getCanonicalName()));
    }
    ...
    public void test12() {
        if(System.getProperty("goog.LOCALE").startsWith("br_rf")) {
            assertEquals("<div id=\"div1\"><div id=\"div2\"><div id=\"div3\"></div><div id=\"div4\"></div></div></div>", impl.test12());
        } else {
    ...
    public void test14() {
        if (System.getProperty("goog.LOCALE").startsWith("br_rf")) {
            ...
            assertEquals("<div id=\"div1\"><div id=\"div2\"><div id=\"div3\">RRRRRRRTranslationService></div><div id=\"div4\"/></div></div>", impl.test14("TranslationService"));
        }
    }
    ...
    public void test22() {
        if(System.getProperty("goog.LOCALE").startsWith("br_rf")) {
            assertEquals("<div id=\"div21\"><div id=\"div22\"><div id=\"div23\"></div><div id=\"div14\"></div></div></div>", impl.test22());
        } else {
    ...
    public void test24() {
        if (System.getProperty("goog.LOCALE").startsWith("br_rf")) {
            assertEquals("<div id=\"div21\"><div id=\"div22\"><div id=\"div23\">RRRRRRRmy_widget></div><div id=\"div4\"></div></div></div>", impl.test24("my_widget"));
        } else {
