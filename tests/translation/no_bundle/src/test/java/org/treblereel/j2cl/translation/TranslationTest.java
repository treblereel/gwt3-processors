...
public class TranslationTest {
  ...
  public void htmlContent() {
    if (System.getProperty("goog.LOCALE").startsWith("br_rf")) {
      ...
      assertEquals(
          "<div id=\"LC1813\" class=\"blob-code blob-code-inner js-file-line\"><span class=\"pl-c\"><div>HELLo</div></span></div>",
          bundle2.htmlContent("<div>HELLo</div>"));
    } else {
      assertEquals(
          "&lt;div class=&quot;blob-code blob-code-inner js-file-line&quot; id=&quot;LC1813&quot;&gt;&lt;span class=&quot;pl-c&quot;&gt;<div>HELLo</div>&lt;/span&gt;&lt;/div&gt;",
          bundle2.htmlContent("<div>HELLo</div>"));
    }
  }
  ...
  public void htmlContentUnescapeHtmlEntitiesTrue() {
    if (System.getProperty("goog.LOCALE").startsWith("fr")) {
      assertEquals(
          "<div class=\"blob-code blob-code-inner js-file-line\" id=\"LC1813\"><span class=\"pl-c\"> * Messages must be initialized in the form:</span></div>",
          bundle2.htmlContentUnescapeHtmlEntitiesTrue(
              " * Messages must be initialized in the form:"));
    } else if (System.getProperty("goog.LOCALE").startsWith("br_rf")) {
      assertEquals(
          "<div id=\"LC1813\" class=\"blob-code blob-code-inner js-file-line\"><span class=\"pl-c\">br_rf</span></div>",
  ...
  public void htmlContentHtmlTrueUnescapeHtmlEntitiesTrue() {
    if (System.getProperty("goog.LOCALE").startsWith("br_rf")) {
      ...
      assertEquals(
          "<div class=\"blob-code blob-code-inner js-file-line\" id=\"LC1813\"><span class=\"pl-c\"> * Messages must be initialized in the form:</span></div>",
          bundle2.htmlContentHtmlTrueUnescapeHtmlEntitiesTrue(
              " * Messages must be initialized in the form:"));
    }
  }
  ...
  public void jsonGreeting() {
    if (System.getProperty("goog.LOCALE").equals("fr")) {
      ...
      assertEquals("Hello from JSON!", jsonBundle.jsonGreeting());
    } else {
